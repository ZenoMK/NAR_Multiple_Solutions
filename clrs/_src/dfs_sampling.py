...
def sample_random_list(outsOrPreds):
    ...
    Args:
        outsOrPreds: nasty nasty nested lists & dicts, eventually unpacked to probMatrices

    Returns:
        trees: a list of dummy "trees" generated by picking a random parent for each vertex
